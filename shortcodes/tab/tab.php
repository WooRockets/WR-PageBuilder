		...
		$this->items = array(
			...
			'styling' => array(
				...
				array(
					...
					'std'     => 'top',
					'options' => array(
						'top'     => __( '<i class="wr-icon-tab-top" title="Top"></i>', WR_PBL ),
						'bottom'  => __( '<i class="wr-icon-tab-bottom" title="Bottom"></i>', WR_PBL ),
						'left'    => __( '<i class="wr-icon-tab-left" title="Left"></i>', WR_PBL ),
						'right'   => __( '<i class="wr-icon-tab-right" title="Right"></i>', WR_PBL ),
					),
				),
